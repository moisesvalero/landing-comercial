<script lang="ts">
  import '$lib/styles/landing-fonts.css';
  ...
  /** Dos series para bucle continuo sin salto (datos desde configuracion o defaults). */
  ...
  const articlesIndexPath = '#recursos';
  const articlesCanonicalBasePath = '#recursos';
  const footerIntro = $derived(
    landingBasePath === '/diseno-web'
      ? 'Diseño y desarrollo web para negocios en toda España.'
      : 'Diseño y desarrollo web para negocios, Espa?a.'
  );
    ...
    stringifyJsonLdForHtml({
      ...
      itemListElement: [
        ...
        },
        {
          '@type': 'ListItem',
          position: 2,
          name: landingBasePath === '/diseno-web' ? 'Diseño web' : 'Diseño web ',
          item: canonicalUrl
        }
      ]
    })
...
>
  ...
  <main class="pt-0">
    ...
    >
      ...
      >
        ...
        <div
          class="hero-marquee"
          role="region"
          aria-label="Capturas de trabajos, carrusel horizontal. Pausa al pasar el cursor o al enfocar un enlace."
        >
    ...
    <section class="reveal-b py-24 bg-surface-container-low px-6 overflow-hidden" id="benefits" use:revealOnScroll>
      <div class="max-w-7xl mx-auto grid md:grid-cols-2 gap-20 items-center">
        <div class="order-2 md:order-1 relative flex items-center">
          ...
          >
            <img
              alt="Diseño web profesional, referencia visual del servicio"
    ...
    {#if supportArticles.length}
      <section class="reveal-b py-24 px-6 bg-surface-container-low" id="recursos" use:revealOnScroll>
        <div class="max-w-7xl mx-auto">
          ...
          <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
            {#each supportArticles as article, idx (article.slug)}
              <a
                ...
                aria-label={`Leer recurso: ${article.title}`}
              >
