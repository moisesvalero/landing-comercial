...
<div class="galeria-nova-page">
  ...
  <div class="stats-section">
    <div class="stats-grid">
      ...
      <div class="stat">
        <span class="stat-num">WebP</span>
        <span class="stat-label">Formato imágenes</span>
      </div>
      <div class="stat">
        <span class="stat-num">4-5</span>
        <span class="stat-label">Días de desarrollo</span>
      </div>
      <div class="stat">
        <span class="stat-num">SVG</span>
        <span class="stat-label">Logo escalable</span>
      </div>
    </div>
  </div>
  ...
  <div class="stack-section">
    <div class="stack-inner">
      ...
      <div class="stack-grid">
        ...
        <span class="stack-item">WooCommerce</span>
        <span class="stack-item">PayPal</span>
        <span class="stack-item">Cloudflare</span>
        <span class="stack-item">Autoptimize</span>
        <span class="stack-item">EWWW Image</span>
        <span class="stack-item">Yoast SEO</span>
        <span class="stack-item">Leonardo.ai</span>
        <span class="stack-item">Cursor Agent</span>
        <span class="stack-item">HTML/CSS</span>
        <span class="stack-item">SVG</span>
      </div>
    </div>
  </div>
