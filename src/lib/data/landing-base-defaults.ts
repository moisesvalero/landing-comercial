...
export const landingBaseDefaults: LandingPageData = {
  sectionOrder: ['hero', 'services', 'benefits', 'faq', 'finalCta'],
  seo: {
    title: 'Dise?o web profesional para captar clientes | Moises Valero',
    description:
      'Servicio de dise?o web profesional orientado a conversion, velocidad y SEO. Desarrollo web con enfoque en rendimiento, negocio y soporte real.',
    ogTitle: 'Dise?o web profesional para empresas y profesionales',
    ogDescription:
      'Landing pages y webs corporativas con enfoque comercial, SEO y mantenimiento continuo.',
    ogImage: '/og-image.png',
    canonicalPath: '/diseno-web',
    twitterCard: 'summary_large_image'
  },
  hero: {
    badge: 'Dise?o web profesional',
    title: 'Diseño web ',
    subtitle:
    ...
    visualDescription:
      'Diseño, desarrollo web, SEO tecnico y stack WordPress/SvelteKit para resultados medibles.',
    visualImageSrc: '/imagenes/Captura-de-pantalla_27-2-2026_114525_moisesvalero.es_.jpeg',
    ...
    items: [
      {
        ...
        summary:
          'La opción más rápida y efectiva para digitalizar tu negocio. Ideal para captar clientes por WhatsApp y Google de forma profesional.',
        priceFrom: '290 €',
        hideFromLabel: true,
        delivery: '72 horas',
        details: [
          ...
          'SEO tecnico: Configuración estratégica para que tu negocio aparezca en las búsquedas de la zona.',
      ...
      },
      {
        ...
        details: [
          'Estructura Multipágina: Hasta 6 secciones independientes (Home, Servicios, Blog, Web principal, Equipo y Contacto) para una imagen corporativa sólida.',
          'Panel de Control (WordPress o gestor de contenido ligero): Libertad para editar textos, subir imagenes o publicar contenidos sin depender de nadie.',
  ...
  benefits: {
    heading: 'Diseño webs que impulsan negocios ',
    ...
    items: [
      ...
      },
      {
        ...
        description:
          'Desarrollo webs ultrarrápidas y optimizadas para que Google te sitúe en las primeras posiciones.'
      }
    ]
  },
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          'Tienes dos opciones. Si eliges la Web Profesional, tendras un panel de gestion para cambiar textos y fotos sin coste. Si prefieres delegarlo, puedes usar soporte puntual por horas.'
      },
      {
        question: '¿Cómo me ayuda la web a salir en Google?',
        answer:
          'Aplico SEO técnico desde la primera línea de código. Esto incluye optimización de velocidad (vital para Google), estructura de encabezados correcta y configuración para el buscador. Si tu negocio está , trabajaremos el SEO Local para que los clientes de la zona te encuentren antes que a tu competencia.'
      }
    ]
  },
  finalCta: {
